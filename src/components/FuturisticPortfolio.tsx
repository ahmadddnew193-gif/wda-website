      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-4xl">
        ...
        <div className="mb-16 pb-16 border-b border-gray-800">
          ...
          >
            {/* Title */}
            <div className="mb-6">
              <h3 className="text-4xl md:text-5xl font-bold text-white mb-4 group-hover:text-blue-400 transition-colors">
                WDA Mall
              </h3>
            ...
            {/* Image */}
            <div className="relative w-full aspect-video rounded-2xl overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900 mb-6">
              <img 
            ...
            {/* Button */}
            <div className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-medium transition-all duration-300 hover:scale-105">
        ...
        <div className="mb-16">
          ...
          >
            {/* Title */}
            <div className="mb-6">
              <h3 className="text-4xl md:text-5xl font-bold text-white mb-4 group-hover:text-purple-400 transition-colors">
                Restaurant Demo
              </h3>
              <div className="flex flex-wrap gap-2 mb-4">
            ...
            {/* Button */}
            <div className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium transition-all duration-300 hover:scale-105">
              <span>Visit Website</span>
              <ExternalLink className="w-5 h-5" />
            </div>
          </a>
        ...
        <div className="text-center mt-20 pt-16 border-t border-gray-800">
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white font-medium transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/30 hover:scale-105"
          >
