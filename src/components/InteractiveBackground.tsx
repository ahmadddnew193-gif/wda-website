...
export default function InteractiveBackground() {
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: isMobile
            ...
            `,
          transition: isMobile ? 'none' : 'background 0.3s ease-out',
        }}
      />
      ...
      {/* Ambient light spots */}
      <div className="fixed top-0 left-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-[120px] pointer-events-none z-[1]" />
      <div className="fixed bottom-0 right-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-[120px] pointer-events-none z-[1]" />
    </>
  );
}
